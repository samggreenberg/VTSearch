# How many of the pages FullMarks calls negatives actually carry the mark?
...
**97.6% of everything FullMarks scores is a page nobody looked at.** That is not
...
`/expscratch/sgreenberg/fullmarks/contamination/verdicts.final.jsonl` (448 rows).
