...
Backbone: DINOv2 ViT-B/14 (`facebook/dinov2-base`) on CPU.  Sample: **30 images** spread across caltech-101 categories (seed = 0, see `scripts/run_hac_tree_sweep.py`).  Mean forward pass: **0.18 s/image** on CPU.
