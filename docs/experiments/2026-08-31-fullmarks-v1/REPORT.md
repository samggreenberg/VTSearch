# FullMarks v1 — the same corpus, with the marks drawn correctly
...
UCSF distractors, same generator as [v0](../2026-08-31-fullmarks-v0/REPORT.md);
what changed is the extractor that decides where a mark *is*.

Regenerate with:

```
python scripts/experiments/fullmarks/make_report.py \
    --corpus <corpus> --out docs/experiments/2026-08-31-fullmarks-v1/report.html
```
...
`scripts/experiments/fullmarks/README.md` § "Masks to marks".
