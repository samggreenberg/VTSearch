# FullMarks v4.0: the completeness passes removed a degenerate shortcut,
# and the new classes are not yet scored on the same footing

**2026-09-20.** FullMarks moved from v3.1 to v4.0: the roster grew from 23
...
Results: `/expscratch/sgreenberg/fullmarks/remeasure-v4/{s,m}/` (job 670431,
38 min). Corpus numbers and the versioning rule are in
[`DATASHEET.md`](../../../scripts/experiments/fullmarks/DATASHEET.md).
