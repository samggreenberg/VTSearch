# FullMarks — a cached Stage 1, and what compressing it costs (#3928)

**2026-09-18.** #3928's probe established the shape of FullMarks' Stage 1:
...
ran, with a concurrent `coco_better` embed wanting ~36 GB of it. So the question
...
python docs/experiments/2026-09-18-fullmarks-stage1-3928/figures.py
```
