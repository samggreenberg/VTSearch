# FullMarks v0 — what the stamp-detection corpus looks like

> **Superseded in part by [v1](../2026-08-31-fullmarks-v1/REPORT.md).** The look-at-it
...
python scripts/experiments/fullmarks/make_report.py \
    --corpus <corpus> --out docs/experiments/2026-08-31-fullmarks-v0/report.html
```
