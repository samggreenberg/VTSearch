# DocMarks — why structural search was at chance, and what fixes it (#3911)

**2026-09-17.** #3904 found `sift_vlad` at chance on the DocMarks roster (VLAD AP
...
python docs/experiments/2026-09-17-docmarks-structural-3911/figures.py
```
