# DocMarks — do Tobacco800 marks leak into UCSF's non-Tobacco pages? (#3914)
...
`docmarks_config.py` itself notes that "Philip Morris reaches Food through
...
For each class, `scripts/experiments/docmarks/food_sheet.py` ranks the tier-`m`
...
python scripts/experiments/docmarks/food_sheet.py ...            # ranked sheets (see --help)
python docs/experiments/2026-09-17-docmarks-food-3914/meta_scan.py measurements/meta_hits.json
python docs/experiments/2026-09-17-docmarks-food-3914/meta_sheets.py measurements/meta_hits.json <out>
python docs/experiments/2026-09-17-docmarks-food-3914/figures.py
```
