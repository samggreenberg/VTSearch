...
Reads ``corpus.jsonl`` from ``VTS_DOCMARKS_OUT`` (tiers s and m only) and writes
...
def main(out: Path) -> int:
    corpus = Path(os.environ.get("VTS_DOCMARKS_OUT", "/expscratch/sgreenberg/docmarks/corpus"))
