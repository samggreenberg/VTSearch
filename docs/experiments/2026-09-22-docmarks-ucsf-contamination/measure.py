...
"""Measurements for the UCSF un-banded contamination check (#3922).
    ...
    cd scripts/experiments/docmarks && python ../../../docs/experiments/2026-09-22-docmarks-ucsf-contamination/measure.py
...
VERDICTS = Path("/expscratch/sgreenberg/docmarks/contam-ucsf/verdicts.final.jsonl")
V40 = frozenset({"ucsf"})
