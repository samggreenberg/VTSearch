# DocMarks: can the four UCSF classes score against the rest of UCSF?
...
([the rule](../2026-09-20-docmarks-contamination/REPORT.md#what-it-licenses-and-what-it-does-not)).
...
python ../../../docs/experiments/2026-09-22-docmarks-ucsf-contamination/measure.py
python ../../../docs/experiments/2026-09-22-docmarks-ucsf-contamination/figures.py
```
...
`/expscratch/sgreenberg/docmarks/contam-ucsf/verdicts.final.jsonl`, and the
