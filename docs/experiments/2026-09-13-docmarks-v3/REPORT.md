...
`/expscratch/sgreenberg/docmarks/corpus/audit/`, so countersigning is looking,
not redoing.
...
|---|---:|---:|---:|---|
| `docmarks_s__siglip.pkl` | 17 MB | 230 s | 5,000 | ok |
| `docmarks_s__sift_vlad.pkl` | 847 MB | 3,840 s | 5,000 | ok |
...
of a cell, so `docmarks_s × sift_vlad` embedded all 5,000 pages, ran **2h 16m at
