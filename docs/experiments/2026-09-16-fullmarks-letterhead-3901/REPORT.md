# FullMarks — do UCSF letterhead bands carry a mark? (#3901)

**2026-09-16.** The `letterhead` pass in `scripts/experiments/fullmarks/README.md`
...
Sheets are rendered by `scripts/experiments/fullmarks/letterhead_sheets.py`;
...
locator, as `fullmarks_config.py` says; any class built from bands still needs
