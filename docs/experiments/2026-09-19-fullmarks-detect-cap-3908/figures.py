...
python figures.py --results /expscratch/sgreenberg/fullmarks/detect-cap-3908 --out .
"""
...
def main() -> int:
    ...
    ap.add_argument("--results", type=Path, default=Path("/expscratch/sgreenberg/fullmarks/detect-cap-3908"))
