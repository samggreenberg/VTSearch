...
| arm | k | Δ final cost [95% CI] | Δ positives@final | Δ positives@100 | Δ AP | Δ oracle cost | pairs |
|---|---:|---|---:|---:|---:|---:|---:|
| `acq_m1` | -1 | -0.0163 [-0.0218, -0.0108] | +16.8 | +3.6 | +0.063 | -0.0210 | 192 |
| `acq_m3` | -3 | -0.0329 [-0.0387, -0.0269] | +90.1 | +17.7 | +0.123 | -0.0313 | 192 |
| `acq_m4` | -4 | -0.0324 [-0.0387, -0.0262] | +99.9 | +27.7 | +0.128 | -0.0324 | 192 |
