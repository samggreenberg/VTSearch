# FullMarks v2 — the full-scale corpus, and what it can actually measure
...
[v1](../2026-08-31-fullmarks-v1/REPORT.md), 1,520 pages.

Regenerate with:

```
python scripts/experiments/fullmarks/make_report.py \
    --corpus <corpus> --out docs/experiments/2026-09-02-fullmarks-v2/report.html
```
