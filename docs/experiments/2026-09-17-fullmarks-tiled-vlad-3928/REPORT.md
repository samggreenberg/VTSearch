# FullMarks — tiled VLAD as the structural Stage 1 (#3928, first probe)
...
`scripts/experiments/fullmarks/eval_stage1_tiles.py`, CPU only:
...
FULLMARKS_TILE_LAYOUTS=t4 python eval_stage1_tiles.py --tier m --budget 8192 \
    --inliers <out>/sift-m-8192/inliers.json --out <out>/tiles-m-8192
python docs/experiments/2026-09-17-fullmarks-tiled-vlad-3928/figures.py
```
