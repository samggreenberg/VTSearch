...
| [c901-refactor-triage.md](c901-refactor-triage.md) | **Refactor 1/8 in flight** | Per-function refactor/skip decisions for the eight remaining functions with cyclomatic complexity ≥20. Companion to [brainstorm.md §20.7.1](brainstorm.md). |
