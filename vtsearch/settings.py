...
if TYPE_CHECKING:
    ...
    def get_browse_minimap_visible() -> bool: ...
    def set_browse_minimap_visible(value: bool) -> None: ...
    def get_browse_minimap_width() -> int: ...
    def set_browse_minimap_width(value: int) -> None: ...
    def get_browse_minimap_height() -> int: ...
    def set_browse_minimap_height(value: int) -> None: ...
