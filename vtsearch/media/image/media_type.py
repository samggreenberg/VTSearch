    ...
    def demo_datasets(self) -> list:
        ...
        return [
            DemoDataset(
                ...
                items_per_category=86, download_size_mb=CALTECH101_DOWNLOAD_SIZE_MB,
            ),
            DemoDataset(
            ...
            DemoDataset(
                ...
                slice_frac_start=0.0, slice_frac_end=None,
                items_per_category=119, download_size_mb=CALTECH256_DOWNLOAD_SIZE_MB,
            ),
            DemoDataset(
                ...
                slice_frac_start=0.0, slice_frac_end=None,
                items_per_category=80, download_size_mb=OXFORD_FLOWERS_DOWNLOAD_SIZE_MB,
            ),
            DemoDataset(
                ...
                slice_frac_start=0.0, slice_frac_end=1 / 7,
                items_per_category=1000, download_size_mb=FOOD101_DOWNLOAD_SIZE_MB,
            ),
            DemoDataset(
            ...
            DemoDataset(
                ...
                slice_frac_start=0.0, slice_frac_end=1 / 7,
                items_per_category=2700, download_size_mb=EUROSAT_DOWNLOAD_SIZE_MB,
            ),
            DemoDataset(
            ...
            DemoDataset(
                ...
                slice_frac_start=0.0, slice_frac_end=1 / 7,
                items_per_category=171, download_size_mb=STANFORD_DOGS_DOWNLOAD_SIZE_MB,
            ),
            DemoDataset(
            ...
            DemoDataset(
                ...
                slice_frac_start=0.0, slice_frac_end=None,
                items_per_category=25, download_size_mb=UCSF_IDL_DOWNLOAD_SIZE_MB,
            ),
        ]
