    ...
    def demo_datasets(self) -> list:
        ...
        return [
            DemoDataset(
                ...
                items_per_category=950, download_size_mb=15,
            ),
            DemoDataset(
            ...
            DemoDataset(
                ...
                slice_frac_start=0.0, slice_frac_end=1 / 7,
                items_per_category=30000, download_size_mb=15,
            ),
            DemoDataset(
