...
def download_dbpedia(
    ...
    The tarball at :data:`~vtsearch.datasets.downloader.core.DBPEDIA_URL`
...
def download_arxiv_abstracts(
    ...
    :data:`~vtsearch.datasets.downloader.core.ARXIV_API_URL`.  Results are
...
def download_reuters21578(
    ...
    :data:`~vtsearch.datasets.downloader.core.REUTERS21578_URL` into
