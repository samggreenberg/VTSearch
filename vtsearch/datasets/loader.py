...
(``from vtsearch.datasets.loader import ...``) continue to work.

* :mod:`vtsearch.datasets.loader_folder` — folder loaders
* :mod:`vtsearch.datasets.loader_pickle` — pickle loaders, sidecars, image embed
* :mod:`vtsearch.datasets.loader_demo` — demo dataset loader
...
from vtsearch.config import EMBEDDINGS_DIR  # noqa: F401  — re-exported & patched in tests
...
from vtsearch.datasets.loader_folder import (  # noqa: E402, F401
...
from vtsearch.datasets.loader_demo import (  # noqa: E402, F401
    _stamp_demo_origin,
    load_demo_dataset,
)

# Backward-compat alias — canonical location is vtsearch.converters.runner
from vtsearch.converters.runner import apply_converter_to_demo as _apply_converter_to_demo  # noqa: E402, F401
