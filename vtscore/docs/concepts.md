...
The dimensionality `D` depends on the embedder:

| Embedder | `name` | D | Notes |
|----------|--------|---|-------|
| LAION-CLAP (audio) | `clap` | 512 | Default for audio. |
| CLAP Music | `clap_music` | 512 | Alternative for music collections. |
| SigLIP (image) | `siglip` | 768 | Default for images. |
| X-CLIP (video) | `xclip` | 768 | Default for video. |
| E5-base-v2 (text) | `e5` | 768 | Default for text. |
| BGE-base-en-v1.5 (text) | `bge` | 768 | Alternative text embedder. |
