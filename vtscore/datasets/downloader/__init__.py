...
# ``from vtscore.datasets import downloader; downloader.core.X`` is visible
...
# that.)
from vtscore.datasets.downloader import (
    audio,
    core,
    documents,
    images,
...
from vtscore.datasets.downloader.core import (
...
# Image downloaders
from vtscore.datasets.downloader.images import (
    download_caltech101,
    download_caltech256,
    download_cifar10,
    download_eurosat,
...
# Video downloaders
from vtscore.datasets.downloader.video import (
    download_hmdb51,
    download_kth,
...
# Text downloaders
from vtscore.datasets.downloader.text import (
...
from vtscore.datasets.downloader.documents import download_ucsf_documents
