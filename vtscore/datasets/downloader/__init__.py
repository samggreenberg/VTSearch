...
from vtscore.datasets.downloader.core import (
    ...
    OPENLOGO_REPO_ID,
    RICO_ICONS_DOWNLOAD_SIZE_MB,
    RICO_ICONS_MANIFEST_MB,
    RICO_ICONS_REPO_ID,
    RICO_ICONS_SHARD_COUNT,
    RICO_ICONS_SHARD_MB,
    RICO_ICONS_SHARD_SIZE,
