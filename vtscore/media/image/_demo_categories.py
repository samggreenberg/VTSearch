...
# vocabulary), used as the multi-label ground-truth space for the VG demo
# dataset.  Unlike every other image demo, these are NOT mutually exclusive: a
# single VG image is typically a positive example of several of these at once
# (e.g. a street photo is in ``car``, ``person``, ``building``, ``sign`` …).
