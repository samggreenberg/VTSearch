"""Demo dataset construction and loading for text media.

Builds the :class:`~vtscore.media.base.DemoDataset` list returned by
``TextMediaType.demo_datasets`` and implements the per-source download
+ embed dispatcher behind ``TextMediaType.load_demo_source``.
...
def build_demo_datasets() -> list[DemoDataset]:
    """Build the demo-dataset catalog exposed by :class:`TextMediaType`."""
    ...
    return [
        ...
        DemoDataset(
            ...
            label="AG News (S)",
            description=ag_desc,
            categories=_AG_NEWS_CATEGORIES,
            source="ag_news",
            slice_frac_start=0.0,
            slice_frac_end=1 / 7,
        ...
        DemoDataset(
            ...
            categories=_BBC_NEWS_CATEGORIES,
            source="bbc_news",
            slice_frac_start=0.0,
            slice_frac_end=None,
        ...
        DemoDataset(
            ...
            categories=_DBPEDIA_CATEGORIES,
            source="dbpedia",
            slice_frac_start=0.0,
            slice_frac_end=1 / 7,
        ...
        DemoDataset(
            ...
            categories=_REUTERS_CATEGORIES,
            source="reuters21578",
            slice_frac_start=0.0,
            slice_frac_end=1 / 7,
...
def load_demo_source(
    ...
    **kwargs,
    ...
    selected_texts, selected_categories = _collect_demo_texts(
        source,
        categories,
        slice_start,
        slice_end,
