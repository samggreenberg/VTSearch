...
SCALE_CLASS_RULES: dict[str, ClassRule] = {
    ...
    "truck": ClassRule(
        ...
        test=(
            ...
            "Use the BODY, not the badge, and ask about CARGO not seats: no cargo "
            "compartment is a Car (a two-seater sportscar counts -- sports car/coupe/"
            "convertible/hatchback are 0 Truck to 15 Car), while panelled sides, a box "
            "body or an open bed is a Truck (ambulance 19/0, delivery van 2/0). Never "
            "squint inside to count rows. `van` names two vehicles and COCO splits it "
            "261 truck / 318 car; `suv` "
