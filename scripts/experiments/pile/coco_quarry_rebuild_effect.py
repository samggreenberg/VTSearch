...
*clean* set, which is the barren component alone. A real ``coco_quarry`` cell's
...
Usage::
    ...
    python coco_quarry_rebuild_effect.py --embedder siglip --json out.json
"""
...
SEED = 0
KEEP25 = Path("/expscratch/sgreenberg/keep/coco-quarry-25-20260920")
...
def main() -> int:
    ...
    old = load_medias(args.keep / f"coco_quarry__{args.embedder}.pkl")
    new = load_medias(pc.EMBEDDINGS / f"coco_quarry__{args.embedder}.pkl")
