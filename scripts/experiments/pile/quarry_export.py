...
new arm and has to be run.
    ...
    python quarry_export.py --cell car@small --test-bands all --out car_small.json
    python quarry_export.py --cell car --train-mix natural --positives 300
    python quarry_export.py --mix-census
