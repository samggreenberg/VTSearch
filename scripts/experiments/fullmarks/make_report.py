#!/usr/bin/env python
"""Render a look-at-it report for a built FullMarks corpus.
...
def build_html(
    ...
    *,
    ...
    return (
        ...
        f"built by <code>scripts/experiments/fullmarks/</code>, rendered by <code>make_report.py</code></p>"
        + "\n".join(parts)
        + "</main></body></html>"
    )
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    ap.add_argument("--title", default="FullMarks v0 — what the corpus looks like")
