"""Score the FullMarks roster: can each embedder find a class from its query crop?
...
Reads cells, writes only under ``--out``:
    ...
    python eval_retrieval.py --tiers s,m --out /expscratch/$USER/fullmarks/eval-3904
