"""Shared paths + environment for the Toponymy audio-signpost experiments.
...
artifacts (embeddings npz, texts, topic trees, metrics) go to RESULTS.
...
WORK = Path(os.environ.get("TOPO_WORK", f"/scratch/jobs/{os.environ.get('USER', 'sgreenberg')}/topo-audio"))
RESULTS = Path(os.environ.get("TOPO_RESULTS", "/exp/sgreenberg/experiments/toponymy-audio/results"))
