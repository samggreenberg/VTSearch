...
Both write the shared interface the multi-method slate reads::
    ...
    /expscratch/sgreenberg/docmarks/completeness2/proposals-<method>.json
...
OUT = Path("/expscratch/sgreenberg/docmarks/completeness2")
OCR_CACHE = Path("/expscratch/sgreenberg/docmarks/ocr/easyocr")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    ap.add_argument("--corpus", type=Path, default=Path("/expscratch/sgreenberg/docmarks/corpus"))
