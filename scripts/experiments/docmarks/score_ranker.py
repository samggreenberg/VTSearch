"""Score any ranker on DocMarks: bring a scores file, get the benchmark's numbers (#4108).

DocMarks exists so that ideas about finding a stamp or logo from one query crop
...
def summarise(rows: Sequence[dict[str, Any]], name: str, stamp: dict[str, Any]) -> str:
    ...
    lines = [
        f"# {name} on DocMarks {stamp['corpus_version']}",
        "",
