"""Grow the DocMarks roster without a rebuild, on a staging copy of the corpus (#4143).
...
staging corpus with ``--corpus <staging>``.
    ...
    python roster_grow.py stage --out /expscratch/$USER/docmarks/corpus-v5
    python roster_grow.py admit --corpus /expscratch/$USER/docmarks/corpus-v5 --classes a,b,c [--apply]
"""
